        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="/admin/news/edit/<?php echo e($event->EVENT_ID); ?>" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="/admin/news/update/<?php echo e($event->EVENT_ID); ?>" method="post" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
