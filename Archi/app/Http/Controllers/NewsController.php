...
class NewsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $events = DB::table('process_event')
                    ...
                    ->paginate(10);
        //
        return view('admin.news_event_list')->with('events', $events);
    }
    ...
    {
        //
        return view('admin.news_event_create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $primary_key = DB::table('process_event')
                    ->select('process_event.EVENT_ID')
                    ->max('EVENT_ID');
        ...
        Session::flash('success', 'News or Event Created Successfully!');
    ...
    public function show($id)
    {
        ...
        //
        return view('admin.news_event_view')->with('events', $events);
    }
    ...
    public function edit($id)
    {
        ...
        //
        return view('admin.news_event_edit')->with('events', $events);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('success', 'News or Event Updated Successfully!');
    ...
    public function status(Request $request, $id)
    {
        ...
        $events = DB::table('process_event')
                ->select('process_event.*')
                ->where('process_event.EVENT_ID', '=', $id)
                ->get();
